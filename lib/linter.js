...
/**
  * Takes an array of things to check, and adds each one.
  * This is useful for checking sets of files, and so forth.
  *
  * Example:
  * 
  *   linter.checkEach(paths, function(path){
  *     if (path.length > 128) this.warn("looks mighty long");
  *   });
  *
  ...
  * @api public
  */
Linter.prototype.checkEach = function(array, fn){
  array.forEach(function(value){
    this.check(value, fn.bind(this, value));
  }, this);
};
